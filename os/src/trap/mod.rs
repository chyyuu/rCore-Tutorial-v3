...
pub fn trap_handler() -> ! {
    ...
    match scause.cause() {
        ...
        Trap::Exception(EXCEPTION_STORE_FAULT)
        | Trap::Exception(EXCEPTION_STORE_PAGE_FAULT)
        | Trap::Exception(EXCEPTION_LOAD_FAULT)
        | Trap::Exception(EXCEPTION_LOAD_PAGE_FAULT) => {
